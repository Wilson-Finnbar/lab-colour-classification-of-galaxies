...
ax3.legend()
plt.tight_layout()
plt.savefig('Figure/partb1zoom.pdf')
...
ax4.legend(loc='best')
plt.tight_layout()
plt.savefig("Figure/urproperties.pdf")
# %%
...
ax5.legend(loc='best')
plt.tight_layout()
plt.savefig("Figure/partcallgalaxy.pdf")
# %%
#Part C: histograms 
...
plt.tight_layout()
plt.savefig("Figure/numbervsredshift.pdf")
